...
class Drone(TrafficParticipant):

    """
    Actor implementation details for drone
    """

    def __init__(self, world, uid, name, parent, node, carla_actor):
        """
        Constructor
        ...
        """
        self.classification = Object.CLASSIFICATION_DRONE
        self.world=world
        super(Drone, self).__init__(uid=uid,
                                      name=name,
                                      parent=parent,
                                      node=node,
